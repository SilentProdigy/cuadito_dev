...
<div id="pricing-page">
        ...
        <div class="row smooth-scroll">
          ...
          <div class="col-md-6 p-5">
            <div class="wow fadeInDown">
                <h1 class="display-3 text-uppercase fw-bold">Pricing &<br>Packages</h1>
                <h5 class="mb-4 fw-normal">Choose the plan that's right for your business.</h5>
                <h5 class="fw-normal">We offer you the perfect plans for you to choose from and get connected to other businesses around the Philippines!</h5>
            </div>
    ...
    <div class="container packages-section my-5">
        <section class="pricing-section">
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-xl-5 col-lg-6 col-md-8">
                        <div class="section-title text-center title-ex1">
                        <h2>Choose your perfect subscription.</h2>
                        </div>
                    </div>
                </div>

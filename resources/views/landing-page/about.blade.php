...
.about-mission .about-text-wrapper{
    /* display: flex; */
...
<div id="about-page">
        ...
        <div class="row smooth-scroll">
          ...
          <div class="col-md-6 p-5">
            <div class="wow fadeInDown">
                <h1 class="display-3 text-uppercase fw-bold font-weight-bold">ABOUT<br>CUADITO</h1>
                <h5 class="mb-4 fw-normal">Cuadito is an online platform designed to help companies streamline their proposal and quotation process.</h5>
                <h5 class="fw-normal">It allows users to submit proposals, send quotations to other companies on the platform, and build stronger connections.
                </h5>
            </div>
    ...
    <div class="container about-mission">
        <div class="row">
            <div class="col-md-6 col-xl-6 p-4">
                <div class="hover-zoom">
                    <img src="{{ asset('images/elements/mission.png') }}"
                      class="img-fluid">
                  </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-6 p-4">
                <div class="hover-zoom">
                    <img src="{{ asset('images/elements/vision.jpg') }}"
                      class="img-fluid">
                  </div>
            </div>
        </div>
    ...
    <div class="container py-5 how-to-section">
        ...
        <div class="row">
            <div class="offset-md-2 offset-xl-2 col-md-8 col-xl-8">
                <div class="d-flex align-items-center justify-content-center">
                    <video class="w-100 shadow-3" controls>
                        <source src="{{ asset('videos/get-to-know.mp4') }}" type="video/mp4" />
                    </video>
                </div> 
            </div>
        </div>

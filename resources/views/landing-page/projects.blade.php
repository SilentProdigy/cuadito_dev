...
<div id="projects-page">
        ...
        <div class="row smooth-scroll">
          ...
          <div class="col-md-6 p-5">
            <div class="wow fadeInDown">
                <h1 class="display-3 text-uppercase fw-bold">Featured<br>Projects</h1>
                <h5 class="mb-4 fw-normal">We help businesses connect with each other through an easy-to-use platform for posting projects and sending quotation proposals.</h5>
                <h5 class="fw-normal">Businesses can easily find partners and suppliers with CUADITO.</h5>
            </div>
    ...
    <div class="container featured-projects"></div>
</div>
@endsection
@section('scripts')
@endsection
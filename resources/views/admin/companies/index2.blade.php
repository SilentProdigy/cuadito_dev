...
<div class="container">
    ...
    <div class="d-flex justify-content-between">
        <div>
            <ul class="nav nav-tabs mb-3" id="comptabs">
                <li class="nav-item" role="presentation">
                    <a href="{{ route('admin.companies.index') }}" class="nav-link {{ is_null($tab) ? 'active' : null }}">New</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="{{ route('admin.companies.index') }}?tab={{$company_states[1]}}" class="nav-link {{ $tab == $company_states[1] ? 'active' : null }}">Approved</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="{{ route('admin.companies.index') }}?tab={{$company_states[0]}}" class="nav-link {{ $tab == $company_states[0] ? 'active' : null }}">Pending</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="{{ route('admin.companies.index') }}?tab={{$company_states[2]}}" class="nav-link {{ $tab == $company_states[2] ? 'active' : null }}">Denied</a>
                </li>
            </ul>
        </div>
        <div>

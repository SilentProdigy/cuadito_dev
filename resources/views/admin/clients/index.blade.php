                        ...
                        <div class="card-body d-flex justify-content-between">
                            ...
                            <div class="client-info cold-xs-6 col-md-6">
                                <div class="client-info-container">
                                    <h5 class="client-name text-black" style="color: black !important;">{{ $client->name }}</h5>
                                    <p class="client-company text-black">{{ $client->company->name }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        btnLifetimePromoButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                let myModal = new bootstrap.Modal(document.getElementById('confirm-lifetime-subscription-modal'), {
                    keyboard: false
                });
                myModal.show();
            });

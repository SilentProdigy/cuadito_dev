    ...
    <div class="container-fluid mb-3">
        <div class="d-flex flex-row d-align-items-center justify-content-center">
            ...
            <div class="col d-flex justify-content-end">
                <button class="btn btn-warning header-btn" data-bs-toggle="modal"
                    data-bs-target="#create-new-conversation-modal">
            ...
            <div>
                <div class="d-flex justify-content-between align-content-center">
                    <div class="fs-5 fw-bold">
                        @if ($item->is_starred)
                            <a href="#" class="text-warning btn-unstar"
                                data-subscription="{{ json_encode($item) }}"><i class="fa fa-star fa-star"></i></a>
                        @endif

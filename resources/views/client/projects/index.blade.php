    ...
    <div class="container">
        <div class="page-breadcrumbs">
            ...
            <div class="right-elements">
                <div>
                    <a href="javascript::void(0)" data-bs-toggle="modal" data-bs-target="#advance-search-modal"><i
                            class="bx bx-slider-alt fs-5 text-black"></i></a>
        ...
        <div class="container">
            ...
            @else
                <button type="button" class="btn btn-orange header-btn" data-bs-toggle="modal"
                    data-bs-target="#no-valid-company-modal">
                    <i class="fa fa-plus"></i>&ensp;Add Project
                </button>
            @endif
        </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="flex">
                                            <div class="estimated-cost">
                                                <small class="text-black">Estimated Cost:
                                                    &#8369;{{ number_format($project->cost, 2) }}</small>
                                            </div>
                                            <div class="start-date">
                                                <small class="text-black">Due Date:
                                                    {{ \Carbon\Carbon::parse($project->due_date)->format('M d,Y') }}</small>
                                            </div>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="right-items d-flex">
                                        ...
                                        <a href="{{ route('client.projects.edit', $project) }}"
                                            class="btn btn-sm btn-dark-gray">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        &ensp;
                                        <a href="#" class="btn btn-sm btn-light-gray btn-delete-project"
